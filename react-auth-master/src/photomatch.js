  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if(idCardFacedetection && selfieFacedetection){
        ...
        if (distance<.5){
          console.log("Picture is  matched")
  ...
  return (
    <>
      <div className="gallery">
        <img ref={idCardRef} src={require('./images/sahil1.jpg')} alt="ID card" height="auto" />
      </div>

      <div className="gallery">
        <img ref={selfieRef} src={require('./images/sahil2.jpg')} alt="Selfie" height="auto" />
      </div>
    </>
  );
}
